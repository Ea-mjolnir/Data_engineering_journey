...
# Script to create main.py orchestrator
...
class PipelineOrchestrator:
    ...
    def aggregate(self, cleaned_data):
        ...
        try:
            ...
            self.loader.s3.upload_json(summary_stats, stats_key)
    ...
    def run(self):
        ...
        try:
            ...
            logger.info(f"Metadata: s3://{Config.S3_BUCKET_NAME}/{metadata_key}")
            logger.info("=" * 60)
...
echo "✅ main.py created successfully at: src/main.py"
echo ""
echo "📂 File location: $(pwd)/src/main.py"
echo ""
